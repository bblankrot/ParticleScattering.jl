...
{
    "location": "incident_fields.html#",
    "page": "Incident Field Types",
    "title": "Incident Field Types",
    "category": "page",
    "text": ""
},

{
    "location": "incident_fields.html#Incident-Field-Types-1",
    "page": "Incident Field Types",
    "title": "Incident Field Types",
    "category": "section",
    "text": "ParticleScattering solves the multiple-scattering equation in the cylindrical wave domain, and thus a transformation is necessary in order to solve for arbitrary incident fields. The following field types are currently supported:"
},

{
    "location": "incident_fields.html#Plane-Wave-1",
    "page": "Incident Field Types",
    "title": "Plane Wave",
    "category": "section",
    "text": "A TM plane wave with angle theta_i relative to the x-axis is represented byE_z^mathrminc (mathbfr) = e^ik(cos theta_i  sin theta_i) cdot mathbfrand constructed by calling PlaneWave(θ_i)."
},

{
    "location": "incident_fields.html#Line-Current-1",
    "page": "Incident Field Types",
    "title": "Line Current",
    "category": "section",
    "text": "E_z^mathrminc (mathbfr) = fraci4 H_0^(1) (kmathbfr - (x_0 y_0))Following standard notation, this is a line current with total current I = ik eta. This source cannot be placed inside a particle, and is constructed with LineSource(x0, y0)."
},

{
    "location": "incident_fields.html#Current-Source-1",
    "page": "Incident Field Types",
    "title": "Current Source",
    "category": "section",
    "text": "A straight line containing an arbitrary single potential density \\sigma, producing the following incident field:E_z^mathrminc (mathbfr) = fraci4 int sigma(mathbfr) H_0^(1) (kmathbfr - mathbfr)  mathrmdmathbfrThe current density of this source is J_z = i sigma k eta. Current sources must lie completely outside all particles, and are contructed with CurrentSource(x1, y1, x2, y2, σ), where (x1,y1) and (x2,y2) denote the start and end points, and σ is an array containing the single layer potential density at equidistant points along the source. For example,using ParticleScattering, PyPlot\nλ = 1\nyc = linspace(-0.5λ, 0.5λ, 100)\nui = CurrentSource(0, -0.5λ, 0, 0.5λ, cos.(π*yc/λ))\n#now plot\nx_points = 100; y_points = 100\nx = linspace(-3λ, 3λ, x_points + 1)\ny = linspace(-3λ, 3λ, y_points + 1)\nxgrid = repmat(x\', y_points + 1, 1)\nygrid = repmat(y, 1, x_points + 1)\npoints = cat(2, vec(xgrid[1:y_points, 1:x_points]) + 3λ/x_points,\n            vec(ygrid[1:y_points, 1:x_points]) + 3λ/y_points)\nu = uinc(2π/λ, points, ui)\npcolormesh(xgrid, ygrid, abs.(reshape(u, y_points, x_points)))\ncolorbar()yields the figure<div style=\"text-align:center\">\n<img alt=halfwave src=\"./assets/halfwave.png\" style=\"width:80%; height:auto; margin:1%; max-width: 400px\">\n</div>"
},
...
{
    "location": "api.html#ParticleScattering.LineSource",
    "page": "API",
...
{
    "location": "api.html#ParticleScattering.PlaneWave",
    "page": "API",
    "title": "ParticleScattering.PlaneWave",
    "category": "type",
...
{
    "location": "api.html#ParticleScattering.calc_near_field-Tuple{Any,Any,Any,ParticleScattering.ScatteringProblem,Any,ParticleScattering.Einc}",
    "page": "API",
...
{
    "location": "api.html#ParticleScattering.optimize_φ-Tuple{Any,Any,Any,ParticleScattering.Einc,Any,Any,Any,Any,Any,Any,Optim.Options,Any}",
    "page": "API",
...
{
    "location": "api.html#ParticleScattering.plot_far_field-Tuple{Any,Any,Any,ParticleScattering.ScatteringProblem,ParticleScattering.PlaneWave}",
    "page": "API",
...
{
    "location": "api.html#ParticleScattering.plot_near_field-Tuple{Any,Any,Any,ParticleScattering.ScatteringProblem,ParticleScattering.Einc}",
    "page": "API",
...
{
    "location": "api.html#ParticleScattering.uinc-Union{Tuple{Any,Array{T,2},ParticleScattering.PlaneWave}, Tuple{T}} where T<:Real",
    "page": "API",
    "title": "ParticleScattering.uinc",
    "category": "method",
    "text": "uinc(k, points, u::Einc)\n\nComputes incident field produced by u with outer wavenumber k at points.\n\n\n\n"
},
