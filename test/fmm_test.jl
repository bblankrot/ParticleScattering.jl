...
u1 = calc_near_field(k0, kin, P, sp, points, θ_i; opt = fmm_options, verbose = false)
u2 = calc_near_field(k0, kin, P, sp, points, θ_i; opt = fmm_options, verbose = true, use_multipole = false)
