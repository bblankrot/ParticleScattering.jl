...
@testset "optimize radius" begin
    ...
    u1_5 = calc_near_field(k0, kin, 5, sp1, points_, pw; opt = fmm_options,
            verbose = false)
    u1_6 = calc_near_field(k0, kin, 6, sp1, points_, pw; opt = fmm_options,
            verbose = false)
    u1_7 = calc_near_field(k0, kin, 7, sp1, points_, pw; opt = fmm_options,
            verbose = false)
    u2_5 = calc_near_field(k0, kin, 5, sp2, points_, pw; opt = fmm_options,
            verbose = false)
    u2_6 = calc_near_field(k0, kin, 6, sp2, points_, pw; opt = fmm_options,
            verbose = false)
    u2_7 = calc_near_field(k0, kin, 7, sp2, points_, pw; opt = fmm_options,
            verbose = false)
